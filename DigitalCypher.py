...
Introduction Digital Cypher assigns to each letter of the alphabet unique
number. For example:
...
string and key number and returns an array of integers representing encoded
str.

Input / Output The str input string consists of lowercase characters only. The
key input number is a positive integer.
