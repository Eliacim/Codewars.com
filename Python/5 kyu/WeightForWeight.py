...
# This is one of the best practices/clever in codewars:
def order_weight3(_str):
    return ' '.join(sorted(sorted(_str.split(' ')),
...
print(order_weight3("2000 10003 1234000 44444444 9999 11 11 22 123"))
# "11 11 2000 10003 22 123 1234000 44444444 9999"
