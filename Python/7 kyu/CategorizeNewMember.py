...
Input Input will consist of a list of lists containing two items each. Each
list contains information for a single potential member. Information consists
...
def open_or_senior(data):
    return ['Senior' if d[0] > 54 and d[1] > 7 else 'Open' for d in data]
