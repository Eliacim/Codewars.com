...
#
# TOO SLOW FOR CODEWARS! - I NEED TO REFACTOR IT :(
#


def exp_sum2(n, item=1):
    yield (n,)
    for i in range(item, n//2 + 1):
        for e in exp_sum2(n - i, i):
            yield (i,) + e


def exp_sum1(n):
    return len(list(exp_sum2(n)))
