...
Intervals Intervals are represented by a pair of integers in the form of an
array. The first value of the interval will always be less than the second
value. Interval example: [1, 5] is an interval from 1 to 5. The length of this
interval is 4.
...
Examples: sumIntervals( [[1,2], [6, 10], [11, 15]] ); // => 9
...
# Reducing the code above to one line
def sum_of_intervals(intervals):
    return len(set([i for ii in intervals for i in range(ii[0], ii[1])]))
